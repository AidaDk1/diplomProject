...
urlpatterns = [
    ...
    path('collections2',views.collections2,name='collections2'),
    path('collections3',views.collections3,name='collections3'),
    path('subcategoryview/<str:title>', views.subcategoryview, name='subcategory'),
    path('productsview/<int:id>', views.productsview, name='productsview'),
